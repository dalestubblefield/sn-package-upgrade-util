function installSpecificAppsUtah(loginType, loginKey) {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    var packageDetails = {
        id: 'com.snc.agent_workspace.itsm.landing_page_premium',
        notes: 'ITSM Workspace Landing Pages - Premium',
        type: 'plugin'
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    var packageDetails = {
        id: 'com.snc.pa.premium.all_content',
        load_demo_data: true,
        notes: 'Performance Analytics - Content Packs for ITSM',
    ...
    var packageDetails = {
        ...
        load_demo_data: true,
        notes: 'Performance Analytics - Premium',
        requested_version: '1.0.0',
        type: 'plugin'
    }
    logEachPackage && log.push("\n     --> " + packageDetails.notes);
    ...
    ////////////////////////////////////////////////////////////////////////////////
    var packageDetails = {
        id: 'com.snc.pa.premium.service_management',
        load_demo_data: true,
        notes: 'Performance Analytics - Service Management Premium',
        requested_version: '1.0.0',
        type: 'plugin'
    }
    logEachPackage && log.push("\n     --> " + packageDetails.notes);
    ...
    ////////////////////////////////////////////////////////////////////////////////
    var packageDetails = {
        id: 'com.snc.pa.sla.overview',
        load_demo_data: true,
        notes: 'Service Level Management PA Dashboard',
        requested_version: '1.0.0',
        type: 'plugin'
    }
    logEachPackage && log.push("\n     --> " + packageDetails.notes);
